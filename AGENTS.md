...
- This repo is the STDS brand frontend serving `~/stds_brand_backend`.
...
- Backend public API reference: `~/stds_brand_backend/docs/api/public-brand-api.md` (`GET /api/v1/brand/profile`, `GET /api/v1/brand/faqs`, `GET /api/v1/properties/availability`, and `/health`).
